          ...
          {!isTrue && (
            <div className="first-div">
                ...
                {tabsList.map(eachValue => (
                  <li key={eachValue.tabId}>
                    <button
                      ...
                      onClick={() => this.onClickTab(eachValue.tabId)}
                    >
              ...
              <ul className="thumbnail-images">
                {thumbnailList.map(eachObjuct => (
                  <li key={eachObjuct.id}>
                    <button
                      type="button"
                      className="image-button"
                      onClick={() => this.imageClick(eachObjuct.thumbnailUrl)}
                    >
                      <img
                        src={eachObjuct.thumbnailUrl}
